...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="{{ url('admin/about-us/update') }}" method="post"  enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="arabic-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        required value="{{ $aboutUs->title_ar }}">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="english-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        required value="{{ $aboutUs->title_en }}">
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane" id="data-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <img src="{{ asset('images/'.resizeImage($aboutUs->image, 50, 50))}}" width="100px" />
