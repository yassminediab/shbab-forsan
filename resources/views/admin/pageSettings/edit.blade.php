...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Page settings</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="{{ url('admin/page/settings/update') }}" method="post"  enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="data-tab">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <img src="{{ asset('images/'.resizeImage($page->image, 50, 50))}}" width="100px" />
