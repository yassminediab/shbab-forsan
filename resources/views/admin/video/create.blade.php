...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="{{ url('admin/video/store') }}" method="post"  enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="data-tab">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="url" placeholder="enter title" required value="{{ old('url') }}">
                            </div>
                        </div>
                    </div>
                </div>
