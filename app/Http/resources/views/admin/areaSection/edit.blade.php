...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="{{ url('admin/area/section/update') }}" method="post"  enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="id" value="{{ $areaSection->id }}">
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="arabic-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="title_ar" placeholder="enter title" required value="{{ $areaSection->title_ar }}">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane" id="english-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="title_en" placeholder="enter title" required value="{{ $areaSection->title_en }}">
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="tab-pane" id="data-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="icon" placeholder="enter title" required  value="{{ $areaSection->icon }}">
                            </div>
                        </div>
                    </div>
                </div>
