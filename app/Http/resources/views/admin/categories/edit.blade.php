...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="{{ url('admin/categories/update') }}" method="post"  enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="arabic-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="title_ar" placeholder="enter title" required value="{{ $category->title_ar }}">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="english-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="title_en" placeholder="enter title" required value="{{ $category->title_en }}">
                                    </div>
                                </div>
