...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="{{ url('admin/cases/store') }}" method="post"  enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="data-tab">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="number" value=" {{ old('target_share') }}" class="form-control" required name="target_share" placeholder="enter target">
                            </div>
                        </div>                        
