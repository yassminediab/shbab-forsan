...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="{{ url('admin/number/store') }}" method="post"  enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="data-tab">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="number" placeholder="enter number" required value="{{ old('number') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="icon" placeholder="enter icon" required value="{{ old('icon') }}">
                            </div>
                        </div>
                    </div>
                </div>
