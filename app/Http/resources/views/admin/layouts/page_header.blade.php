...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="overflow: hidden;">
          ...
          && $modelName != 'volunteer/section' && $modelName != 'blog/section' &&  $modelName != 'case/section' &&  $modelName != 'problem/section' && $modelName != 'footer' && $modelName != 'About' && $modelName != 'socialMedia' )
