        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title white desktop-center margin-bottom-50">
                    <h3 class="title">
                        @if(app()->getLocale() == "en") {{ $testimonialSection->title_en }} @else {{ $testimonialSection->title_ar }} @endif
                    </h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="content">
                            <div class="author-details">
                                <div class="author-meta">
                                    <h4 class="title">
                                        @if(app()->getLocale() == "en") {{ $testimonial->item_title_en }} @else {{ $testimonial->item_title_ar }} @endif
                                    </h4>
                                </div>
                            </div>
                            <p class="description">
                                @if(app()->getLocale() == "en") {{ \Str::limit(Strip_tags($testimonial->item_content_en), $limit = 80, $end = '...')  }}
                                    @else {{ \Str::limit(Strip_tags($testimonial->item_content_ar), $limit = 80, $end = '...')  }}
                                @endif 
                            </p>
                        </div>
                    </div>
